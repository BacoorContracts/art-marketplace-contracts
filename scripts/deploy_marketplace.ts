...
async function main(): Promise<void> {
  ...
  const logic: Contract = await upgrades.deployProxy(Logic, ["0x25433bACDa338631a9e8a493c4b280d94497f4Ae", "0xD39A527516d19b5cfddDd58A2544E52257a3323F"], { kind: "uups", initializer: "init" });
